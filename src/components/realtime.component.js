    ...
    return (
        <div className="realtime">
            ...
            <div className="realtime-extras">
                <div className="realtime-feels-like">
                    Feels Like{' '}
                    <Temp value={realtime.intervals[0].values.temperatureApparent} />°
                </div>
                <div className="realtime-humidity">
                    Humidity <Temp value={realtime.intervals[0].values.humidity} />%
                </div>
                <div className="realtime-wind">
                    Wind{' '}
                    <Wind
                        speed={realtime.intervals[0].values.windSpeed}
                        gust={realtime.intervals[0].values.windGust}
                    />
                </div>
            </div>
            <div className="realtime-icon">
                <WeatherIcon value={realtime.intervals[0].values.weatherCode} />
                <div className="realtime-weather-code">
                    {prettyPrintWeatherCode(realtime.intervals[0].values.weatherCode)}
                </div>
            </div>
